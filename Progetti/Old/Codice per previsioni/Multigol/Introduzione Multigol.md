#### Modificare la struttura per far in modo, che indipendentemente dalla quota inserita, che non dovrà essere inserita, calcoli la quota minima per avere un vantaggio del 10%
